...
//   { name: 'MyClass', description: 'Speak directly to your customers', href: '/', icon: CursorArrowRaysIcon },
      ...
      <nav className="mx-auto flex max-w-7xl items-center justify-between p-6 lg:px-8" aria-label="Global">
        ...
        {User === "user" &&
          <Popover.Group className="hidden lg:flex lg:gap-x-12">
            ...
            <Link to={"/MyClass"} className="text-sm font-semibold leading-6 text-gray-900">MyClass</Link>
          </Popover.Group>}
        ...
        {User === "Instructor" &&
          <Popover.Group className="hidden lg:flex lg:gap-x-12">
            ...
            {/*<Link to={"/MyClass"} className="text-sm font-semibold leading-6 text-gray-900">Classes</Link>*/}
          </Popover.Group>}
                ...
                <div>
                  {User === "user" &&
                    <div>
                      ...
                      <Link to={"/MyClass"} className="-mx-3 block rounded-lg px-3 py-2 text-base font-semibold leading-7 text-gray-900 hover:bg-gray-50">Class</Link>
                    </div>
                  }
                </div>
